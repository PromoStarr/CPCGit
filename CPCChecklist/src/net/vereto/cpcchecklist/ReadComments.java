package net.vereto.cpcchecklist;
...
public class ReadComments extends ListActivity {
    ...
    private static final String READ_COMMENTS_URL = "http://vereto.net/webservice/cpc/comments.php";
  
  //JSON IDS:
    private static final String TAG_SUCCESS = "success";
    private static final String TAG_POSTS = "posts";
    private static final String TAG_ITEM_ID = "item_id";
    private static final String TAG_ITEM = "item_name";
    private static final String TAG_DESCRIPT = "item_descript";
    ...
    public void updateJSONdata() {
        ...
        try {
            ...
            for (int i = 0; i < mComments.length(); i++) {
                ...
                ID = c.getString(TAG_ITEM_ID);

                // creating new HashMap
                HashMap<String, String> map = new HashMap<String, String>();              

                map.put(TAG_DESCRIPT, content);
